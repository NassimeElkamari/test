...
const BlogCard = ({ imageSrc, title, description, date }) => {
  return (
    <div className='w-[40%] h-[45%] bg-black rounded-xl flex flex-col'>
    <div className="w-[100%] h-2/5 relative">
    <Image
  src={imageSrc}
  layout="fixed" // Use "fixed" layout for explicit width and height
  width={100}
  height={100}
  alt="Card Image"
  className="h-full rounded-t-xl bg-blue-800"
/>
