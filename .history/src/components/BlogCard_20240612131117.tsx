  ...
  return (
    <div className='w-[40%] h-[50%] bg-black rounded-xl flex flex-col'>
      <div className="w-[100%] h-2/5 relative">
        <Image
          src={imageSrc} // Image source passed as prop
          layout="responsive"
      ...
      <div className="pt-10 flex justify-center items-center flex-col px-5">
        <h1 className="text-[32px] font-semibold">{title}</h1> {/* Title passed as prop */}
        <p className="text-md mt-5">{description}</p> {/* Description passed as prop */}
      </div>
      <div className="flex items-center justify-end mt-10 mr-2">
        <MdDateRange width={70} height={70} className='mr-4'/>
        <p className="mr-2">{date}</p> {/* Date passed as prop */}
      </div>
