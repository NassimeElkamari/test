  ...
  return (
    <div  className='flex h-[100vh] w-[100vw] bg-white'>
        ...
        <div className="first-section right-side w-full flex-1 flex-col flex items-center justify-center">
          ...
          <div className="flex justify-center mt-8 mb-6 w-[60%] bg-white"> {/* Added justify-center class */}
        <button className="bg-white rounded-[14px] shadow-md w-[30%] text-center h-10 border border-blue-700 flex items-center justify-center">
