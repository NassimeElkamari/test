    ...
    <div className='flex flex-col bg-white h-auto w-full'>
      ...
      <div ref={section1Ref} className='flex h-[100vh] w-[100vw]'>
        <div className="left-side bg-[#004AAD] w-[40%] flex items-center justify-end pr-2">
          <Image width={480} height={480} alt='Former' src='/business1.png' />
        </div>
      ...
      <div ref={section2Ref} className='mt-5 flex h-[100vh] w-[100vw]'>
        <div className="left-side bgwhite w-[40%] flex items-center justify-end pr-2">
          <Image width={480} height={480} alt='Préparer' src='/business2.png' />
        </div>
        <div className="second-section right-side w-full flex-1 flex-col flex items-center justify-center">
          ...
          <div className="mb-6 w-full justify-center items-center flex-col flex">
            ...
            <select className="w-[80%] p-3 mb-4 border rounded-xl text-black">
              <option className="text-black" value="" disabled selected>Taille de l'entreprise</option>
              {/* Add options here */}
              <option className="text-black" value="Paris">1-50</option>
              <option className="text-black" value="Berlin">50-200</option>
              <option className="text-black" value="Madrid">+200</option>
            </select>
          </div>
          <div className="w-[40%] flex items-center justify-center">
      ...
      <div ref={section3Ref} className='mt-5 flex h-[100vh] w-[100vw]'>
        <div className="left-side bg-[#004AAD] w-[40%] flex items-center justify-end pr-2">
          <Image width={480} height={480} alt='Développer' src='/business3.png' />
        </div>
        <div className="third-section right-side w-full flex-1 flex-col flex items-center justify-center">
          <div className="mb-[10%] w-[40%] flex items-center justify-center">
          ...
          <div className="mb-6 w-full justify-center items-center flex-col flex">
            ...
            <textarea className="w-[80%] p-3 mb-4 border rounded-xl text-black" rows={6} placeholder="Quels sont les besoins en formation ? (Facultatif)"></textarea>
          </div>
          <div className="w-[80%] flex justify-end">
            <button className="border-2 border-blue-500 text-blue-500 py-2 px-6 rounded-xl">S'inscrire</button>
          </div>
        </div>
      </div>
