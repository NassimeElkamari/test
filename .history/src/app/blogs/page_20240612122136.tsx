...
const Blog = () => {
  return (
    <div className='bg-white'>
      ...
      <div className='w-[40%] h-[100%] bg-black rounded-xl flex flex-col'>
...
/>
        ...
        <div className="p-4">
          <h1 className="text-[36px] font-semibold">L'impact des médias sociaux sur la santé mental</h1>
          <p className="text-sm">Discuter de la façon dont les likes, les commentaires et les partages peuvent devenir une mesure de notre valeur personnelle, et comment cela peut affecter notre estime de soi et notre bien-être émotionnel...</p>
        </div>
      </div>
    </div>
