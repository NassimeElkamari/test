...
const Blog = () => {
  return (
    ...
    <div className="flex justify-center mb-4"> {/* Added justify-center class */}
        <button className="bg-black rounded-lg shadow-md w-[15%] text-center h-10 border border-[#A7E92F] flex items-center justify-center">
        <h2 className="text-lg font-semibold text-white">Lire plus</h2> {/* Added text-white class */}
        </button>
    </div>
    </div>
