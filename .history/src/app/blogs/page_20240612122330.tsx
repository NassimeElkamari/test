    ...
    <div className='bg-white'>
      ...
      <div className='w-[40%] h-[100%] bg-black rounded-xl flex flex-col'>
        ...
        <div className="pt-10 flex justify-center items-center flex-col px-5">
          ...
          <p className="text-md mt">Discuter de la façon dont les likes, les commentaires et les partages peuvent devenir une mesure de notre valeur personnelle, et comment cela peut affecter notre estime de soi et notre bien-être émotionnel...</p>
        </div>
      </div>
    </div>
