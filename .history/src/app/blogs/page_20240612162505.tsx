  ...
  return (
    <div className='bg-white'>
      ...
      <div className="bg-[#1D4ED8] py-10 mt-10 flex flex-col items-center justify-center">
        ...
        <div className="bg-white  py-[2px] rounded-xl shadow-lg flex flex-col items-center sm:flex-row mt-2 w-full max-w-3xl">
          <input
            type="email"
            placeholder="Entrez votre adresse email"
            className="w-full sm:w-2/3 p-3 mb-4 sm:mb-0 sm:mr-4 rounded-lg focus:outline-none"
          />
          <button className="bg-black text-white font-semibold py-3 px-6 rounded-xl flex flex-end shadow-md w-full sm:w-auto">
            S’abonner
          </button>
        </div>
      </div>
