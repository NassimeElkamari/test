  ...
  return (
    <div className='bg-white'>
      ...
      <div className="bg-[#1D4ED8] py-10 mt-10 flex flex-col items-center justify-center">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center sm:flex-row">
          <input
            type="email"
            placeholder="Enter your email"
            className="w-64 p-3 mb-4 sm:mb-0 sm:mr-4 rounded-lg focus:outline-none"
          />
          <button className="bg-[#1D4ED8] text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-[#1B4DB8]">
