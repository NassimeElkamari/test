...
const Blog = () => {
  return (
    <div className='bg-white'>
      ...
      <div className="relative w-[95vw] h-[90vh] mx-auto overflow-hidden bg-black  pt-5 pl-8 flex flex-col justify-start rounded-2xl">
        <Image
          src="/bgImage.jpg"
          layout="fill"
          objectFit="cover"
        ...
        />
        <div className="absolute inset-0 flex flex-col justify-center text-white mt-[12%] p-4 pl-8">
