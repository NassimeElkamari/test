...
const Blog = () => {
  return (
    <div className='bg-white'>
      ...
      <div className="bg-transparent rounded-lg shadow-md w-[15%] text-center h-10 mb-4 border border-[#1D4ED8] flex items-center justify-center">
              <h2 className="text-lg font-semibold">Explorer plus de blogs </h2>
            </div>
