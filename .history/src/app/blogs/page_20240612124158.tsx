  ...
  return (
    ...
    <div className='second-section w-[92vw] h-[85vh] mx-auto mt-10'>
        <div className='w-[40%] h-[120%] bg-black rounded-xl flex flex-col'>
            ...
            <button className="bg-black rounded-lg shadow-md w-[15%] text-center h-10 mb-4 border border-[#A7E92F] flex items-center justify-center">
              <h2 className="text-lg font-semibold">Lire plus</h2>
            </button>
