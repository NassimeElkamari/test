  ...
  return (
    <div className='bg-white'>
      ...
      <div className="bg-[#1D4ED8] py-10 mt-10 flex flex-col items-center justify-center">
        <h2 className="text-3xl font-semibold text-white mb-4">S’abonner</h2>
        <div className="bg-white px-4 py-2 rounded-lg shadow-lg flex flex-col items-center sm:flex-row">
          <input
            type="email"
            placeholder="Entrez votre adresse email"
            className="w-64 p-3 mb-4 sm:mb-0 sm:mr-4 rounded-lg focus:outline-none"
          />
          <button className="bg-black text-white font-semibold py-3 px-6 rounded-lg shadow-md ">
          Inscrirez-vous à nos newsletters
          </button>
        </div>
      </div>
    </div>
