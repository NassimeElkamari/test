...
const Blog = () => {
  return (
    <div className='bg-white'>
      ...
      <div className="relative w-[95vw] h-[85vh] mx-auto overflow-hidden bg-black  pt-5 pl-8 flex flex-col justify-start rounded-2xl">
        <Image
          src="/bgImage.jpg"
          layout="fill"
          objectFit="cover"
        ...
        <div className="absolute inset-0 flex flex-col justify-center text-white mt-[6%] p-4 pl-8">
          ...
          <div className="flex flex-wrap justify-evenly space-x-4 w-[80%]">
            <div className="bg-transparent rounded-lg shadow-md py-1 px-6 w-50 h-10 mb-4 border border-[#A7E92F]">
            ...
            <div className="bg-transparent rounded-lg shadow-mdw-[15%] h-10 mb-4 border border-[#A7E92F]">
              <h2 className="text-lg font-semibold">IT</h2>
            </div>
            <div className="bg-transparent rounded-lg shadow-md w-[15%] h-10 mb-4 border border-[#A7E92F]">
              <h2 className="text-lg font-semibold text-center">Psychologie</h2>
            </div>
