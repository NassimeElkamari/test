    ...
    <div className='bg-white'>
      ...
      <div className="relative w-[95vw] h-[80vh] mx-auto overflow-hidden bg-black  pt-5 pl-8 flex flex-col justify-start rounded-2xl">
        ...
        <div className="absolute inset-0 flex flex-col justify-center text-white p-4 pl-8">
          ...
          Découvrez les dernières actualités de 2peerfect dans une multitude de domaines passionnants. <br />Plongez-vous dans nos articles pour rester à jour sur les tendances les plus récentes en technologie, <br /> santé mentale, Design, Business, et bien plus encore. Avec une expertise diversifiée et des perspectives variées, 2peerfect vous offre un aperçu complet et captivant des développements les plus récents à travers différents secteurs. Ne manquez rien de ce qui se passe dans le monde, suivez 2peerfect pour rester informé et inspiré.
          </p>
