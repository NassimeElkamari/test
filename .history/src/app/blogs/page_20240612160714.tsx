  ...
  return (
    <div className='bg-white'>
      ...
      <div className="flex justify-center mt-10">
        <button className=" text-white rounded-lg shadow-md w-[30%] text-center h-10 border border-[#1D4ED8] flex items-center justify-center">
          <h2 className="text-lg font-semibold text-[#1D4ED8]">Explorer plus de blogs </h2>
        </button>
      </div>
    </div>
  );
