      ...
      <div className="relative w-[95vw] h-[80vh] mx-auto overflow-hidden bg-black  pt-5 pl-8 flex flex-col justify-start rounded-2xl">
        ...
        <div className="absolute inset-0 flex flex-col justify-center text-white mt-[14%] p-4 pl-8">
          ...
          <div className="flex flex-wrap space-x-4">
            <div className="bg-transparent rounded-lg shadow-md py-1 w-50 h-10 mb-4 border border-[#A7E92F]">
              <h2 className="text-2xl font-semibold mb-4">Marketing</h2>
            </div>
            <div className="bg-transparent rounded-lg shadow-md py-3 w-50 h-10 mb-4 border border-[#A7E92F]">
              <h2 className="text-2xl font-semibold">Marketing</h2>
            </div>
            <div className="bg-transparent rounded-lg shadow-md p-3 w-50 h-10 mb-4 border border-[#A7E92F]">
              <h2 className="text-2xl font-semibold mb-4">Marketing</h2>
            </div>
