...
const Blog = () => {
  return (
    <div className='bg-white'>
      ...
      <div className="relative w-[92vw] h-[85vh]  overflow-hidden bg-black  pt-5 pl-8 flex flex-col justify-start rounded-2xl">
        <Image
          src="/bgImage.jpg"
          layout="fill"
          objectFit="cover"
      ...
      <div className='second-section w-[92vw] h-[85vh] mx-auto'>
        <div className='w-[20%] h-[50%] bg-blue-100'>
