...
const Blog = () => {
  return (
    ...
    <div className="flex justify-center mt-4"> {/* Added justify-center class */}
        <button className="bg-black rounded-lg shadow-md w-[50%] text-center h-10 border border-[#A7E92F] flex items-center justify-center">
