  ...
  return (
    <div className='bg-white'>
      ...
      <div className="relative w-[92vw] h-[85vh] mx-auto overflow-hidden bg-black pt-5 pl-8 flex flex-col justify-start rounded-2xl">
        ...
        <div className="absolute inset-0 flex flex-col justify-center text-white mt-[6%] p-4 pl-8">
          ...
          <div className="flex flex-wrap justify-between space-x-4 w-[80%]">
            <div className="bg-transparent rounded-xl shadow-md w-[15%] h-10 mb-4 border border-[#A7E92F] flex items-center justify-center">
            ...
            <div className="bg-transparent rounded-xl shadow-md w-[15%] h-10 mb-4 border border-[#A7E92F] flex items-center justify-center">
              <h2 className="text-xl font-semibold text-center">Business</h2>
            </div>
            <div className="bg-transparent rounded-xl shadow-md w-[15%] h-10 mb-4 border border-[#A7E92F] flex items-center justify-center">
              <h2 className="text-xl font-semibold text-center">IT</h2>
            </div>
            <div className="bg-transparent rounded-xl shadow-md w-[15%] text-center h-10 mb-4 border border-[#A7E92F] flex items-center justify-center">
              <h2 className="text-xl font-semibold">Psychologie</h2>
            </div>
      ...
      <div className="bg-[#1D4ED8] py-10 mt-10 flex flex-col items-center justify-center">
        <h2 className="text-3xl font-semibold text-white mb-4">Inscrivez-vous à nos newsletters</h2>
        <div className="bg-white py-[2px] pr-[2px] pl-[5px] mt-4 rounded-xl shadow-lg flex items-center justify-between w-full max-w-3xl">
          <input
            type="email"
            placeholder="Entrez votre adresse email"
            className="w-full sm:w-2/3 p-3 text-black rounded-lg focus:outline-none"
          />
          <button className="bg-black text-white text-xl font-semibold py-3 px-12 rounded-xl shadow-md ml-4">
            S’abonner
          </button>
        </div>
      </div>
