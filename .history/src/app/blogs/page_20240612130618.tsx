...
const Blog = () => {
  return (
    <div className='bg-white'>
      ...
      <div className='second-section w-[92vw] mx-auto mt-10 flex justify-center'>
  <div className="flex flex-wrap justify-between">
    <div className="w-[80%] mb-4"> {/* Set each card to take up 50% of the container width */}
      <BlogCard/>
    </div>
    <div className="w-[50%] mb-4"> {/* Set each card to take up 50% of the container width */}
      <BlogCard/>
    </div>
    <div className="w-[50%] mb-4"> {/* Set each card to take up 50% of the container width */}
      <BlogCard/>
