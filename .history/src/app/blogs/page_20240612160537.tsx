  ...
  return (
    <div className='bg-white'>
      ...
      <div className="flex justify-center mt-10">
        <button className="bg-black text-white rounded-lg shadow-md w-40 text-center h-10 border border-[#A7E92F] flex items-center justify-center">
          <h2 className="text-lg font-semibold">Voir plus</h2>
        </button>
      </div>
    </div>
  );
