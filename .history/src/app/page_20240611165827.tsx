    ...
    <div className='flex flex-col bg-white h-auto w-full'>
      ...
      <div ref={section2Ref} className='mt-5 flex h-[100vh] w-[100vw]'>
        ...
        <div className="second-section right-side w-full flex-1 flex-col flex items-center justify-center">
          ...
          <div className="mb-6 w-full justify-center items-center flex-col flex">
            <select className="w-[80%] p-3 mb-4 border rounded-xl" aria-placeholder="Pays">
              <option>Pays</option>
              {/* Add your options here */}
            </select>
            <select className="w-[80%] p-3 mb-4 border rounded-xl" aria-placeholder="Ville">
              <option>Ville</option>
              {/* Add your options here */}
            </select>
            <input className="w-[80%] p-3 mb-4 border rounded-xl" type="text" placeholder="Nom d'entreprise" />
            <input className="w-[80%] p-3 mb-4 border rounded-xl" type="text" placeholder="Taille de l'entreprise" />
          </div>
          <div className="w-[40%] flex items-center justify-center">
      ...
      <div ref={section3Ref} className='mt-5 flex h-[100vh] w-[100vw]'>
        ...
        <div className="third-section right-side w-full flex-1 flex-col flex items-center justify-center">
          ...
          <div className="mb-6 w-full justify-center items-center flex-col flex">
            <input className="w-[80%] p-3 mb-4 border rounded-xl" type="number" placeholder="Nombre de personnes à former" />
            <input className="w-[80%] p-3 mb-4 border rounded-xl" type="text" placeholder="Titre de formation" />
            <textarea className="w-[80%] p-3 mb-4 border rounded-xl" placeholder="Quels sont les besoins en formation ? (Facultatif)"></textarea>
          </div>
          <div className="w-[40%] flex items-center justify-center">
            <button className="bg-blue-500 text-white p-3 rounded-xl">S'inscrire</button>
          </div>
        </div>
      </div>
